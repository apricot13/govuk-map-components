...
export class KeyboardEditor extends HTMLElement {
  ...
  #getPointerCoords = () => {
    const keyboardPointer = this.querySelector(
      ".keyboard-pointer"
    ) as HTMLDivElement;
  ...
  #dispatchMouseMove = () => {
    ...
    document
      .elementFromPoint(newCoords.x, newCoords.y)
  ...
  #handleKeyDown(event: KeyboardEvent) {
    ...
    if (event.key.toLowerCase() === "m") {
      this.#toggleKeyboardEditMode(
        !this.classList.contains("keyboard-editor---edit-mode")
      );
