...
export class MapEditMode extends HTMLElement {
  ...
  #setupEventListeners() {
    this.querySelectorAll('.map__edit-controls input[type="radio"]')?.forEach(
      radio => {
    ...
    this.reactiveStore.entityType.subscribe(
      (entityType: "polygon" | "marker") => {
  ...
  #setEditMode() {
    (
      this.querySelectorAll(
        '.map__edit-controls input[type="radio"]'
